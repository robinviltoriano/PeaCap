...
class EVCap(Blip2Base):
    ...
    def encode_img(self, image):
        ...
        with self.maybe_autocast():
            ...
            # query_output_img_224 = self.mlp_layer(query_output_img_224)
            ...
            multi_modal_outputs = self.Qformer.bert(
                text.input_ids,
                query_embeds=query_tokens,
            ...
            multimodal_embeds = multi_modal_outputs.last_hidden_state[:, : query_tokens.size(1), :]
            ...
            qform_all_proj = self.llama_proj(multimodal_embeds)
