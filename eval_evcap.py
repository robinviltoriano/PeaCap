...
def main(args) -> None:
    ...
    print('load:', ckpt)
    model = EVCap(
            # ext_path = 'ext_data/ext_memory_lvis.pkl', ## change
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name_of_datasets', default = 'coco', choices = ('coco', 'flickr30k', 'nocaps', 'whoops','coco_val2014'))
    ...
    parser.add_argument('--ext_data_path', type = str, default='ext_data/ext_memory_lvis.pkl', help = 'path to the external data')
    parser.add_argument('--ckpt', type = str, default='results/train_evcap/000.pt', help = 'path to the checkpoint')
